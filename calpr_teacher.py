...
Author: jsventek (Joe Sventek)
"""

import sys      # For command-line arguments 
import datetime # To determine what day of week a month begins on
...
for i in range(7):
	if i < starts_weekday :
		...
		# Common logic for printing one day
		print('{:3d}'.format(month_day), end="")
		month_day += 1
print()
